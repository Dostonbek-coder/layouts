                ...
                <ul class="navbar-nav align-items-center ms-lg-5">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                            <li><a class="dropdown-item active" href="{{route('listing')}}">Job Listings</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Technical Lead</a>
                                </h4>
                                ...
                                <div class="d-flex align-items-center border-top pt-3">
                                    ...
                                    <a href="{{route('detalies')}}" class="custom-btn btn ms-auto">Apply now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Marketing Assistant</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Programmer</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">HR Manager</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Sales Representative</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Graphic Designer</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Customer Support</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Language Teacher</a>
                                </h4>
                     ...
                     <div class="col-lg-4 col-md-6 col-12">
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="{{route('detalies')}}" class="job-title-link">Sound Engineer</a>
                                </h4>
