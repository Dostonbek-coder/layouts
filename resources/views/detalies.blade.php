                    ...
                    <ul class="navbar-nav align-items-center ms-lg-5">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item active" href="{{route('detalies')}}">Job Details</a></li>
                            </ul>
                        </li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-12 d-flex ms-auto mb-5 mb-lg-4">
                            <a href="{{route('listing')}}" class="custom-btn custom-border-btn btn ms-lg-auto">Browse Job Listings</a>
                        </div>
